...
def main():
    music_list = load_music_files("Music/")
    print(music_list)
    Audio(music_list[3], rate=44100)
    
    spectrograms = np.array([return_specgram(samples) for samples in music_list])
    print(spectrograms)
...
def return_specgram(samples: np.ndarray):
    """
